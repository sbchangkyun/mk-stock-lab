...
export const marketUniverses: MarketUniverse[] = [
  {
    ...
    constituents: [
      ...
      { symbol: '373220', name: 'LG Energy Solution', sector: 'Materials', value: 235, baseChangePct: -1.6, momentum: -1.4, trend: -2.8 },
  ...
  },
  {
    ...
    currency: 'KRW',
    constituents: [
      { symbol: '247540', name: 'Ecopro BM', sector: 'Materials', value: 230, baseChangePct: 2.7, momentum: 3.4, trend: 6.3 },
      { symbol: '086520', name: 'Ecopro', sector: 'Materials', value: 185, baseChangePct: -2.1, momentum: -2.6, trend: -3.4 },
  ...
  },
  {
    ...
    currency: 'USD',
    constituents: [
      { symbol: 'AAPL', name: 'Apple', sector: 'Technology', value: 650, baseChangePct: 0.9, momentum: 0.6, trend: 3.2 },
      { symbol: 'MSFT', name: 'Microsoft', sector: 'Technology', value: 640, baseChangePct: 1.5, momentum: 1.4, trend: 4.8 },
      { symbol: 'NVDA', name: 'NVIDIA', sector: 'Technology', value: 610, baseChangePct: 4.2, momentum: 5.2, trend: 8.1 },
  ...
  },
  {
    ...
    currency: 'USD',
    constituents: [
      { symbol: 'NVDA', name: 'NVIDIA', sector: 'Semiconductors', value: 620, baseChangePct: 4.2, momentum: 5.2, trend: 8.1 },
      { symbol: 'AVGO', name: 'Broadcom', sector: 'Semiconductors', value: 300, baseChangePct: 2.6, momentum: 2.7, trend: 6.8 },
      ...
      { symbol: 'AAPL', name: 'Apple', sector: 'Mega Cap Tech', value: 610, baseChangePct: 0.9, momentum: 0.6, trend: 3.2 },
      { symbol: 'MSFT', name: 'Microsoft', sector: 'Mega Cap Tech', value: 600, baseChangePct: 1.5, momentum: 1.4, trend: 4.8 },

...
export const providerEnvRegistry: ProviderEnvMetadata[] = [
  { name: 'KIS_APP_KEY', provider: 'kis', owner: 'owner', serverOnly: true, browserSafe: false, requiredPhase: '3I', shouldLogValue: false },
  { name: 'KIS_APP_SECRET', provider: 'kis', owner: 'owner', serverOnly: true, browserSafe: false, requiredPhase: '3I', shouldLogValue: false },
  { name: 'KIS_BASE_URL', provider: 'kis', owner: 'engineering', serverOnly: true, browserSafe: false, requiredPhase: '3I', shouldLogValue: false },

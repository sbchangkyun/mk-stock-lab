...
// Phase 3GG-A-PLAN (Live KIS/LLM approval & runtime binding plan, planning-only)
// and Phase 3GG-B (Live KIS approval gate checklist, owner-reviewable, no
// activation) add planning-only deliverables, no source or runtime change.
// Tolerated here, not required, for the same reason as the groups above.

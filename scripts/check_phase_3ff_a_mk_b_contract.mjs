...
const allowedFiles = new Set([...CORE_DELIVERABLES, ...PATCHED_SIBLING_CHECKERS, ...SP_B_TOLERATED_FILES, ...MK_C_TOLERATED_FILES, ...LATER_PHASE_TOLERATED_FILES, ...HANDOFF_A_TOLERATED_FILES, ...PLAN_AND_SCAFFOLD_TOLERATED_FILES, ...GUARDED_PRODUCTIZATION_UI_STATIC_SHELL_FILES]);

...
// package exists on top of 3edc84b.
...
// src/pages/chart-ai.astro, already a CORE_DELIVERABLE for this checker)
// plus its own smoke/checker/result deliverables. Tolerated here, not
// required, so this checker's git-diff scope check does not fail once that
// phase exists on top of 3edc84b. No protective assertion below is weakened
// by this addition.
...
const TOLERATED_HEADERS_ABOVE_UI_A = [

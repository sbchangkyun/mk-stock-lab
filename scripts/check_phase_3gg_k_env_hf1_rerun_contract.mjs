...
const ALLOWED_MODIFIED_FILES = new Set([
  ...
  // Phase 3GG-K-ENV-HF1-RERUN-3 tolerance: this checker is re-run as a regression check after
  // K-ENV-HF1-RERUN-3, a later, explicitly authorized diagnostic-rerun-only phase that adds its
  // own result doc/checker/package.json/changelog deliverables and reuses this phase's diagnostic
  // script unchanged. Policed by check_phase_3gg_k_env_hf1_rerun_3_contract.mjs, not this one.

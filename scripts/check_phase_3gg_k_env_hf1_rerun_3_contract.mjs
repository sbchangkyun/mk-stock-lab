...
const ALLOWED_MODIFIED_FILES = new Set([
  ...
  // Phase 3GG-K-ENV-HF2 checker-compatibility tolerance (documented per that phase's work order):
  'docs/planning/phase_3gg_k_env_hf2_owner_delegated_kis_live_quotes_env_correction_result_v0.1.md',

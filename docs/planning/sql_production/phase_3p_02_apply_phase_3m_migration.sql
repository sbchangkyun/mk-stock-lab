...
-- Script 02: apply Phase 3M migration.
-- Run only in the confirmed production Supabase project after Script 01 returns all pass.
-- Do not run in the disposable validation project.
-- Stop if the SQL Editor context is unclear.
-- Do not paste outputs containing project refs, URLs, keys, tokens, screenshots, or secrets.
-- This file copies supabase/migrations/20260621_market_quote_cache_lifecycle_columns.sql.
